const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-misc-CRnL6q1x.js","assets/vendor-react-DPbgfP6P.js","assets/vendor-radix-CVjBVM-k.js","assets/vendor-3d-1C4puMsN.js","assets/vendor-state-D8ATIBeW.js","assets/vendor-konva-Ca8PhNs_.js","assets/vendor-charts-DnuE2emq.js"])))=>i.map(i=>d[i]);
import{a as n,j as e,o as D,a1 as se,a2 as $,ag as H,bS as de,aN as ve,bU as ke,q as me,bX as Ne,I as q,O as ue,v as T,B as E,aY as pe,U as he,aS as Y,a0 as Ce,t as Z,b2 as ie,aR as je,bY as Re,_ as Me,$ as Pe,bZ as Te,b as Ae,w as Ie,aF as Ge,ar as ne,n as K,am as Fe,z as De,ak as J,b_ as ge,b$ as Ee,ad as ze,Z as Le,ah as Oe,S as fe,y as ee,a$ as oe,c0 as He,aC as Be,bV as Ue,c1 as We}from"./vendor-react-DPbgfP6P.js";import{a as j,g as R,c as xe,b as Ve,d as Ke,m as $e}from"./Home-BZWQ8jGL.js";import{_ as qe}from"./vendor-3d-1C4puMsN.js";import{getHardwareCapabilities as Ze,ensureWorkerPool as Xe,getWorkerStats as te,getMemorySnapshot as ae}from"./hardware-engine-CBV111ST.js";import"./vendor-misc-CRnL6q1x.js";import"./vendor-radix-CVjBVM-k.js";import"./vendor-state-D8ATIBeW.js";import"./vendor-konva-Ca8PhNs_.js";import"./vendor-charts-DnuE2emq.js";import"./appVersion-BmCirrzV.js";import"./index-DkDSwxt6.js";import"./vendor-query-CR2klDDG.js";import"./gpu-tier-BLGm8vll.js";function B(t){return t>=1e9?`${(t/1e9).toFixed(1)} GB`:t>=1e6?`${(t/1e6).toFixed(0)} MB`:`${t} B`}function _e(t){const s=Math.floor(t/3600),i=Math.floor(t%3600/60);return`${s}h ${i}m`}function Qe({value:t,color:s}){return e.jsx("div",{className:"w-full bg-white/[0.06] rounded-full h-1.5 overflow-hidden",children:e.jsx("div",{className:`h-full rounded-full transition-all duration-700 ${s}`,style:{width:`${Math.min(100,t)}%`}})})}function A({icon:t,label:s,value:i,sub:o,percent:r,color:a,accent:l}){return e.jsxs("div",{className:`rounded-xl p-3.5 border ${l} bg-white/[0.02] flex flex-col gap-2`,children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:`w-7 h-7 rounded-lg flex items-center justify-center ${a}`,children:t}),e.jsx("span",{className:"text-[11px] text-zinc-500 font-medium uppercase tracking-wide",children:s})]}),e.jsxs("div",{children:[e.jsx("div",{className:"text-base font-semibold text-zinc-100 leading-tight",children:i}),o&&e.jsx("div",{className:"text-[10px] text-zinc-600 mt-0.5",children:o})]}),r!==void 0&&e.jsx(Qe,{value:r,color:r>85?"bg-red-500":r>65?"bg-amber-500":"bg-emerald-500"})]})}function Ye(){const[t,s]=n.useState(null),[i,o]=n.useState(!0),[r,a]=n.useState(new Date),l=n.useCallback(async()=>{try{const h=await(await j(R("/system/info"),{signal:AbortSignal.timeout(5e3)})).json();s(h),a(new Date)}catch{}o(!1)},[]);return n.useEffect(()=>{l();const p=setInterval(l,5e3);return()=>clearInterval(p)},[l]),i?e.jsx("div",{className:"flex items-center justify-center h-48",children:e.jsxs("div",{className:"flex items-center gap-2 text-zinc-600 text-sm",children:[e.jsx(D,{className:"w-4 h-4 animate-spin"}),"Loading system info…"]})}):t?e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold text-zinc-100",children:t.hostname}),e.jsxs("p",{className:"text-[11px] text-zinc-600 mt-0.5",children:[t.platform," ",t.osRelease," · ",t.arch," · ",t.cpuCores," cores"]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("span",{className:`flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold ${t.network.isOnline?"bg-emerald-500/10 border border-emerald-500/25 text-emerald-400":"bg-red-500/10 border border-red-500/25 text-red-400"}`,children:[t.network.isOnline?e.jsx(se,{className:"w-2.5 h-2.5"}):e.jsx($,{className:"w-2.5 h-2.5"}),t.network.isOnline?"Online":"Offline"]}),e.jsxs("span",{className:"text-[10px] text-zinc-700",children:["Updated ",r.toLocaleTimeString()]})]})]}),e.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-3 gap-3",children:[e.jsx(A,{icon:e.jsx(H,{className:"w-3.5 h-3.5 text-blue-400"}),label:"CPU",value:`${t.cpuUsage}%`,sub:t.cpuModel.split(" ").slice(0,4).join(" "),percent:t.cpuUsage,color:"bg-blue-500/15",accent:"border-blue-500/15"}),e.jsx(A,{icon:e.jsx(de,{className:"w-3.5 h-3.5 text-purple-400"}),label:"RAM",value:`${t.ram.percent}%`,sub:`${B(t.ram.used)} / ${B(t.ram.total)}`,percent:t.ram.percent,color:"bg-purple-500/15",accent:"border-purple-500/15"}),t.disk&&e.jsx(A,{icon:e.jsx(ve,{className:"w-3.5 h-3.5 text-amber-400"}),label:"Disk",value:`${t.disk.percent}%`,sub:`${B(t.disk.used)} / ${B(t.disk.total)} · ${t.disk.mount}`,percent:t.disk.percent,color:"bg-amber-500/15",accent:"border-amber-500/15"}),e.jsx(A,{icon:e.jsx(ke,{className:"w-3.5 h-3.5 text-emerald-400"}),label:"Battery",value:t.battery.hasBattery&&t.battery.percent!==null?`${t.battery.percent}%`:"N/A",sub:t.battery.hasBattery?t.battery.isCharging?"Charging":"On battery":"No battery / AC power",percent:t.battery.hasBattery&&t.battery.percent!==null?t.battery.percent:void 0,color:"bg-emerald-500/15",accent:"border-emerald-500/15"}),e.jsx(A,{icon:e.jsx(me,{className:"w-3.5 h-3.5 text-zinc-400"}),label:"Uptime",value:_e(t.uptime),sub:"Since last boot",color:"bg-zinc-500/15",accent:"border-zinc-500/15"}),e.jsx(A,{icon:e.jsx(Ne,{className:"w-3.5 h-3.5 text-indigo-400"}),label:"OS",value:t.platform,sub:t.osRelease,color:"bg-indigo-500/15",accent:"border-indigo-500/15"})]}),t.workerPool&&e.jsxs("div",{className:"rounded-xl p-3.5 border border-cyan-500/15 bg-white/[0.02]",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-2",children:[e.jsx("div",{className:"w-7 h-7 rounded-lg flex items-center justify-center bg-cyan-500/15",children:e.jsx(H,{className:"w-3.5 h-3.5 text-cyan-400"})}),e.jsx("span",{className:"text-[11px] text-zinc-500 font-medium uppercase tracking-wide",children:"Worker Pool"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-x-4 gap-y-1",children:[e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"CPU Threads"}),e.jsx("span",{className:"text-zinc-300",children:t.workerPool.cpuCount})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Pool Size"}),e.jsx("span",{className:"text-zinc-300",children:t.workerPool.poolSize})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Jobs Done"}),e.jsx("span",{className:"text-cyan-400 font-medium",children:t.workerPool.totalProcessed})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Avg Time"}),e.jsxs("span",{className:"text-cyan-400 font-medium",children:[t.workerPool.avgComputeMs,"ms"]})]})]})]}),e.jsx("p",{className:"text-[10px] text-zinc-700 text-right",children:"Auto-refresh every 5 seconds · All processors active"})]}):e.jsx("div",{className:"flex items-center justify-center h-48 text-red-400 text-sm",children:"Failed to load system info"})}function Je({msg:t}){const s=t.role==="user";return e.jsxs("div",{className:`flex gap-2.5 ${s?"flex-row-reverse":"flex-row"} mb-3`,children:[e.jsx("div",{className:`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center ${s?"bg-blue-500/20 border border-blue-500/30":"bg-indigo-500/20 border border-indigo-500/30"}`,children:s?e.jsx(he,{className:"w-3.5 h-3.5 text-blue-400"}):e.jsx(E,{className:"w-3.5 h-3.5 text-indigo-400"})}),e.jsxs("div",{className:`max-w-[75%] flex flex-col gap-1 ${s?"items-end":"items-start"}`,children:[e.jsx("div",{className:`rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed ${s?"bg-blue-600/25 border border-blue-500/20 text-zinc-100":"bg-white/[0.04] border border-white/[0.06] text-zinc-200"}`,children:t.content}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsx("span",{className:"text-[10px] text-zinc-700",children:new Date(t.timestamp).toLocaleTimeString()}),e.jsx("span",{className:`text-[9px] px-1.5 py-0.5 rounded-full font-medium ${t.mode==="online"?"bg-emerald-500/10 text-emerald-500":"bg-amber-500/10 text-amber-500"}`,children:t.mode==="online"?"Online AI":"Offline AI"})]})]})]})}function et(){const[t,s]=n.useState([]),[i,o]=n.useState(""),[r,a]=n.useState(!1),[l,p]=n.useState(!0),[h,y]=n.useState(!1),g=n.useRef(null),f=n.useRef(null),m=xe(),b=()=>{g.current?.scrollIntoView({behavior:"smooth"})};n.useEffect(()=>{b()},[t,r]);const S=n.useCallback(async()=>{try{const d=await(await j(R("/ai/memory"))).json();d.memory&&d.memory.length>0&&s(d.memory)}catch{}p(!1)},[]);n.useEffect(()=>{S()},[S]);const c=async()=>{if(confirm("Clear all AI memory? This cannot be undone."))try{await j(R("/ai/memory"),{method:"DELETE"}),s([])}catch{}},w=async()=>{const x=i.trim();if(!x||r)return;const d={id:`${Date.now()}-u`,role:"user",content:x,timestamp:new Date().toISOString(),mode:h||!m.isOnline?"offline":"online"};s(k=>[...k,d]),o(""),a(!0);try{const N=await(await j(R("/ai/chat"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:x,forceOffline:h||!m.isOnline,personalGeminiKeys:Ke(),personalDeepseekKey:Ve()||void 0})})).json();if(N.failedKeyIds?.length)for(const L of N.failedKeyIds)$e(L);const z={id:N.assistantEntry?.id??`${Date.now()}-a`,role:"assistant",content:N.response,timestamp:N.assistantEntry?.timestamp??new Date().toISOString(),mode:N.mode??"offline"};s(L=>[...L,z])}catch{const k={id:`${Date.now()}-err`,role:"assistant",content:"Sorry, I could not connect to the AI engine. Please check your connection and try again.",timestamp:new Date().toISOString(),mode:"offline"};s(N=>[...N,k])}a(!1),f.current?.focus()},v=x=>{x.key==="Enter"&&!x.shiftKey&&(x.preventDefault(),w())},C=h||!m.isOnline?"offline":"online";return e.jsxs("div",{className:"flex flex-col h-full gap-0",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 py-3 border-b border-white/[0.06] flex-shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(q,{className:"w-4 h-4 text-indigo-400"}),e.jsx("span",{className:"text-sm font-semibold text-zinc-100",children:"Ultra AI Chat"}),e.jsx("span",{className:`text-[10px] px-2 py-0.5 rounded-full font-semibold ${C==="online"?"bg-emerald-500/10 border border-emerald-500/25 text-emerald-400":"bg-amber-500/12 border border-amber-500/30 text-amber-400"}`,children:C==="online"?e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(se,{className:"w-2.5 h-2.5"})," Online AI"]}):e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx($,{className:"w-2.5 h-2.5"})," Offline AI"]})})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("label",{className:"flex items-center gap-1.5 cursor-pointer select-none",children:[e.jsx("div",{onClick:()=>y(!h),className:`w-7 h-4 rounded-full transition-colors relative ${h?"bg-amber-500/70":"bg-zinc-700"}`,children:e.jsx("div",{className:`absolute top-0.5 w-3 h-3 rounded-full bg-white transition-transform ${h?"translate-x-3.5":"translate-x-0.5"}`})}),e.jsx("span",{className:"text-[10px] text-zinc-500",children:"Force Offline"})]}),e.jsxs("button",{onClick:c,title:"Clear memory",className:"flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] text-red-400 bg-red-500/8 border border-red-500/15 hover:bg-red-500/15 transition-colors",children:[e.jsx(ue,{className:"w-3 h-3"})," Clear"]})]})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto p-4 min-h-0",children:[l&&e.jsxs("div",{className:"flex items-center justify-center h-20 text-zinc-600 text-sm gap-2",children:[e.jsx(T,{className:"w-4 h-4 animate-spin"})," Loading memory…"]}),!l&&t.length===0&&e.jsxs("div",{className:"flex flex-col items-center justify-center h-32 text-zinc-600 text-sm gap-2",children:[e.jsx(E,{className:"w-8 h-8 text-zinc-700"}),e.jsx("p",{children:"Start a conversation with Ultra AI"}),e.jsx("p",{className:"text-[11px]",children:'Try: "What is roll forming?" or "Show CPU usage tips"'})]}),t.map(x=>e.jsx(Je,{msg:x},x.id)),r&&e.jsxs("div",{className:"flex gap-2.5 mb-3",children:[e.jsx("div",{className:"w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center bg-indigo-500/20 border border-indigo-500/30",children:e.jsx(E,{className:"w-3.5 h-3.5 text-indigo-400"})}),e.jsx("div",{className:"bg-white/[0.04] border border-white/[0.06] rounded-2xl px-4 py-3",children:e.jsxs("div",{className:"flex gap-1 items-center",children:[e.jsx("div",{className:"w-1.5 h-1.5 bg-zinc-500 rounded-full animate-bounce [animation-delay:0ms]"}),e.jsx("div",{className:"w-1.5 h-1.5 bg-zinc-500 rounded-full animate-bounce [animation-delay:150ms]"}),e.jsx("div",{className:"w-1.5 h-1.5 bg-zinc-500 rounded-full animate-bounce [animation-delay:300ms]"})]})})]}),e.jsx("div",{ref:g})]}),e.jsxs("div",{className:"px-4 pb-4 pt-2 flex-shrink-0 border-t border-white/[0.06]",children:[e.jsxs("div",{className:"flex gap-2 items-end",children:[e.jsx("textarea",{ref:f,value:i,onChange:x=>o(x.target.value),onKeyDown:v,placeholder:"Ask anything… (Enter to send, Shift+Enter for newline)",rows:2,className:`flex-1 bg-white/[0.04] border border-white/[0.08] rounded-xl px-3.5 py-2.5
                       ...
                       transition-colors flex-shrink-0`,children:r?e.jsx(T,{className:"w-4 h-4 animate-spin"}):e.jsx(pe,{className:"w-4 h-4"})})]}),e.jsx("p",{className:"text-[10px] text-zinc-700 mt-1.5",children:"Memory is persistent — conversations saved automatically"})]})]})}function tt(t){return t>=1e9?`${(t/1e9).toFixed(1)} GB`:t>=1e6?`${(t/1e6).toFixed(1)} MB`:t>=1e3?`${(t/1e3).toFixed(0)} KB`:`${t} B`}function at({path:t,onNavigate:s}){const i=t.split("/").filter(Boolean);return e.jsxs("div",{className:"flex items-center gap-1 text-[11px] flex-wrap",children:[e.jsx("button",{onClick:()=>s("/"),className:"text-zinc-500 hover:text-zinc-300 transition-colors flex items-center gap-0.5",children:e.jsx(Te,{className:"w-3 h-3"})}),i.map((o,r)=>{const a="/"+i.slice(0,r+1).join("/");return e.jsxs(Ae.Fragment,{children:[e.jsx(Ie,{className:"w-3 h-3 text-zinc-700"}),e.jsx("button",{onClick:()=>s(a),className:`transition-colors ${r===i.length-1?"text-zinc-300 font-medium":"text-zinc-500 hover:text-zinc-300"}`,children:o})]},a)})]})}function st(){const[t,s]=n.useState(null),[i,o]=n.useState(!0),[r,a]=n.useState(null),[l,p]=n.useState(null),[h,y]=n.useState(null),[g,f]=n.useState(!1),[m,b]=n.useState(null),[S,c]=n.useState(!1),[w,v]=n.useState(!1),[C,x]=n.useState(null),d=n.useRef(null),k=n.useRef(0),N=n.useCallback(async u=>{o(!0),a(null),p(null),y(null);try{const P=await(await j(R(`/files/list?dir=${encodeURIComponent(u)}`))).json();P.error?a(P.error):(s(P),b(P.current))}catch{a("Failed to load directory")}o(!1)},[]);n.useEffect(()=>{N("/home")},[N]);const z=async u=>{if(u.isDirectory){N(u.path);return}f(!0),y(u.name),p(null);try{const P=await(await j(R(`/files/read?path=${encodeURIComponent(u.path)}`))).json();p(P.content)}catch{p("[Error reading file]")}f(!1)},L=async u=>{try{await j(R("/files/open"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({filePath:u.path})})}catch{}},re=async u=>{if(!m||u.length===0)return;v(!0),x(null);const M=new FormData;Array.from(u).forEach(P=>M.append("files",P));try{const X=await(await j(R(`/files/upload?dir=${encodeURIComponent(m)}`),{method:"POST",body:M})).json();X.success?(x({text:`${X.count} file(s) uploaded`,ok:!0}),N(m)):x({text:X.error??"Upload failed",ok:!1})}catch{x({text:"Upload failed",ok:!1})}v(!1),setTimeout(()=>x(null),4e3)},be=u=>{u.preventDefault(),k.current++,u.dataTransfer.items&&u.dataTransfer.items.length>0&&c(!0)},ye=u=>{u.preventDefault(),k.current--,k.current===0&&c(!1)},Se=u=>{u.preventDefault(),u.dataTransfer.dropEffect="copy"},we=u=>{u.preventDefault(),c(!1),k.current=0;const{files:M}=u.dataTransfer;M.length>0&&re(M)};return e.jsxs("div",{className:`flex flex-col h-full gap-0 relative transition-colors ${S?"bg-blue-500/5":""}`,onDragEnter:be,onDragLeave:ye,onDragOver:Se,onDrop:we,children:[S&&e.jsx("div",{className:`absolute inset-0 z-50 flex items-center justify-center
                        bg-blue-500/10 border-2 border-dashed border-blue-500/50 rounded-lg pointer-events-none`,children:e.jsxs("div",{className:"flex flex-col items-center gap-2 text-blue-300",children:[e.jsx(Y,{className:"w-10 h-10"}),e.jsx("p",{className:"text-sm font-semibold",children:"Drop files to upload here"})]})}),e.jsxs("div",{className:"flex items-center gap-2 px-4 py-3 border-b border-white/[0.06] flex-shrink-0",children:[e.jsx("button",{onClick:()=>t?.parent&&N(t.parent),disabled:!t?.parent,className:"p-1.5 rounded-lg text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.06] disabled:opacity-30 transition-colors",children:e.jsx(Ce,{className:"w-4 h-4"})}),t&&e.jsx(at,{path:t.current,onNavigate:N}),e.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[C&&e.jsxs("span",{className:`flex items-center gap-1 text-[11px] px-2 py-0.5 rounded-full ${C.ok?"text-emerald-400 bg-emerald-500/10":"text-red-400 bg-red-500/10"}`,children:[C.ok?e.jsx(Z,{className:"w-3 h-3"}):e.jsx(ie,{className:"w-3 h-3"}),C.text]}),e.jsxs("button",{onClick:()=>d.current?.click(),disabled:w||!m,className:`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-medium
                       text-blue-400 bg-blue-500/10 border border-blue-500/20
                       hover:bg-blue-500/20 disabled:opacity-40 transition-colors`,title:"Upload files (or drag & drop onto the file list)",children:[w?e.jsx(T,{className:"w-3 h-3 animate-spin"}):e.jsx(Y,{className:"w-3 h-3"}),"Upload"]}),e.jsx("input",{ref:d,type:"file",multiple:!0,className:"hidden",onChange:u=>u.target.files&&re(u.target.files)})]})]}),e.jsxs("div",{className:"flex flex-1 overflow-hidden",children:[e.jsxs("div",{className:"flex-1 overflow-y-auto p-3 min-h-0",children:[i&&e.jsxs("div",{className:"flex items-center justify-center h-32 text-zinc-600 text-sm gap-2",children:[e.jsx(T,{className:"w-4 h-4 animate-spin"})," Loading…"]}),r&&!i&&e.jsxs("div",{className:"flex items-center justify-center h-32 text-red-400 text-sm gap-2",children:[e.jsx(ie,{className:"w-4 h-4"})," ",r]}),!i&&!r&&t&&t.items.length===0&&e.jsxs("div",{className:"flex flex-col items-center justify-center h-32 text-zinc-600 text-sm gap-2",children:[e.jsx("p",{children:"Empty directory"}),e.jsx("p",{className:"text-[11px]",children:"Drag & drop files here to upload"})]}),!i&&!r&&t&&e.jsx("div",{className:"grid gap-0.5",children:t.items.map(u=>e.jsxs("div",{className:`flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer
                    hover:bg-white/[0.05] transition-colors group
                    ${h===u.name?"bg-blue-500/10 border border-blue-500/15":"border border-transparent"}`,onDoubleClick:()=>u.isDirectory?N(u.path):z(u),onClick:()=>!u.isDirectory&&z(u),children:[e.jsx("div",{className:`w-6 h-6 flex items-center justify-center rounded flex-shrink-0 ${u.isDirectory?"text-amber-400":"text-zinc-500"}`,children:u.isDirectory?e.jsx(je,{className:"w-4 h-4"}):e.jsx(Re,{className:"w-4 h-4"})}),e.jsx("span",{className:`flex-1 text-sm truncate ${u.isDirectory?"text-zinc-200 font-medium":"text-zinc-400"}`,children:u.name}),u.isFile&&e.jsx("span",{className:"text-[10px] text-zinc-700 hidden group-hover:inline",children:tt(u.size)}),e.jsxs("div",{className:"hidden group-hover:flex items-center gap-1",children:[u.isFile&&e.jsx("button",{onClick:M=>{M.stopPropagation(),z(u)},className:"p-1 rounded text-zinc-600 hover:text-zinc-300 hover:bg-white/[0.08]",title:"Preview",children:e.jsx(Me,{className:"w-3 h-3"})}),e.jsx("button",{onClick:M=>{M.stopPropagation(),L(u)},className:"p-1 rounded text-zinc-600 hover:text-zinc-300 hover:bg-white/[0.08]",title:"Open with system",children:e.jsx(Pe,{className:"w-3 h-3"})})]})]},u.path))})]}),(h||g)&&e.jsxs("div",{className:"w-80 border-l border-white/[0.06] flex flex-col flex-shrink-0",children:[e.jsxs("div",{className:"px-3 py-2.5 border-b border-white/[0.06] flex items-center justify-between",children:[e.jsx("span",{className:"text-[11px] font-medium text-zinc-400 truncate",children:h}),e.jsx("button",{onClick:()=>{y(null),p(null)},className:"text-zinc-700 hover:text-zinc-400 text-xs",children:"✕"})]}),e.jsxs("div",{className:"flex-1 overflow-auto p-3",children:[g&&e.jsxs("div",{className:"flex items-center gap-2 text-zinc-600 text-sm",children:[e.jsx(T,{className:"w-3.5 h-3.5 animate-spin"})," Loading…"]}),l&&e.jsx("pre",{className:"text-[11px] text-zinc-400 whitespace-pre-wrap break-words font-mono leading-relaxed",children:l})]})]})]}),m&&e.jsxs("div",{className:"px-4 py-2 border-t border-white/[0.06] text-[10px] text-zinc-700 flex-shrink-0 truncate",children:[m," · ",t?.items.length??0," items · Drag & drop files to upload"]})]})}function le({label:t,desc:s,value:i,onChange:o}){return e.jsxs("div",{className:"flex items-center justify-between py-3 border-b border-white/[0.05]",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-zinc-200 font-medium",children:t}),s&&e.jsx("p",{className:"text-[11px] text-zinc-600 mt-0.5",children:s})]}),e.jsx("button",{onClick:()=>o(!i),className:`w-10 h-5.5 rounded-full transition-colors relative flex-shrink-0 ${i?"bg-blue-600":"bg-zinc-700"}`,style:{height:"22px",width:"40px"},children:e.jsx("div",{className:`absolute top-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform ${i?"translate-x-5":"translate-x-0.5"}`})})]})}function _({label:t,desc:s,value:i,onChange:o,options:r}){return e.jsxs("div",{className:"flex items-center justify-between py-3 border-b border-white/[0.05]",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-zinc-200 font-medium",children:t}),s&&e.jsx("p",{className:"text-[11px] text-zinc-600 mt-0.5",children:s})]}),e.jsx("select",{value:i,onChange:a=>o(a.target.value),className:`bg-white/[0.06] border border-white/[0.10] rounded-lg px-2.5 py-1.5
                   text-[12px] text-zinc-200 focus:outline-none focus:border-blue-500/40 transition-colors`,children:r.map(a=>e.jsx("option",{value:a.value,className:"bg-[#151525]",children:a.label},a.value))})]})}function rt(){const[t,s]=n.useState({language:"english",responseStyle:"detailed",accuracyMode:"high",memoryEnabled:!0,forceOffline:!1,backupIntervalSeconds:60}),[i,o]=n.useState(!0),[r,a]=n.useState(!1),[l,p]=n.useState(!1),[h,y]=n.useState([]),[g,f]=n.useState(!1),[m,b]=n.useState(null),S=n.useCallback(async()=>{try{const k=await(await j(R("/ai/settings"))).json();s(k)}catch{}o(!1)},[]),c=n.useCallback(async()=>{try{const k=await(await j(R("/backup/list"))).json();y(k.backups??[])}catch{}},[]);n.useEffect(()=>{S(),c()},[S,c]);const w=async()=>{a(!0),p(!1);try{await j(R("/ai/settings"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),p(!0),setTimeout(()=>p(!1),3e3)}catch{}a(!1)},v=async()=>{f(!0),b(null);try{(await(await j(R("/backup/create"),{method:"POST"})).json()).success&&(b("Backup created successfully"),c())}catch{b("Backup failed")}f(!1),setTimeout(()=>b(null),4e3)},C=async d=>{if(confirm(`Restore from backup "${d}"? This will overwrite current AI memory.`)){try{const N=await(await j(R("/backup/restore"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:d})})).json();N.success&&b(N.message??"Restored")}catch{b("Restore failed")}setTimeout(()=>b(null),4e3)}},x=d=>{s(k=>({...k,...d}))};return i?e.jsxs("div",{className:"flex items-center justify-center h-32 text-zinc-600 text-sm gap-2",children:[e.jsx(T,{className:"w-4 h-4 animate-spin"})," Loading settings…"]}):e.jsxs("div",{className:"flex flex-col gap-6 p-4 overflow-y-auto max-h-full",children:[e.jsxs("section",{children:[e.jsx("h4",{className:"text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2",children:"AI Behavior"}),e.jsxs("div",{className:"bg-white/[0.02] border border-white/[0.06] rounded-xl px-4",children:[e.jsx(_,{label:"Response Language",desc:"Language for AI replies",value:t.language,onChange:d=>x({language:d}),options:[{value:"english",label:"English"},{value:"urdu",label:"Urdu (اردو)"},{value:"hindi",label:"Hindi (हिंदी)"}]}),e.jsx(_,{label:"Response Style",desc:"How detailed should AI answers be",value:t.responseStyle,onChange:d=>x({responseStyle:d}),options:[{value:"concise",label:"Concise"},{value:"detailed",label:"Detailed"}]}),e.jsx(_,{label:"Accuracy Mode",desc:"Balance between speed and accuracy",value:t.accuracyMode,onChange:d=>x({accuracyMode:d}),options:[{value:"high",label:"High Accuracy"},{value:"fast",label:"Fast Response"}]}),e.jsx(le,{label:"Enable AI Memory",desc:"Save conversations persistently to disk",value:t.memoryEnabled,onChange:d=>x({memoryEnabled:d})}),e.jsx(le,{label:"Force Offline Mode",desc:"Always use offline AI, even when internet is available",value:t.forceOffline,onChange:d=>x({forceOffline:d})}),e.jsxs("div",{className:"flex items-center justify-between py-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-zinc-200 font-medium",children:"Backup Interval"}),e.jsx("p",{className:"text-[11px] text-zinc-600 mt-0.5",children:"How often to auto-save AI memory (seconds)"})]}),e.jsx("input",{type:"number",min:10,max:3600,value:t.backupIntervalSeconds,onChange:d=>x({backupIntervalSeconds:parseInt(d.target.value)||60}),className:`w-20 bg-white/[0.06] border border-white/[0.10] rounded-lg px-2.5 py-1.5
...
- Keep answers focused and actionable`,ot=[{patterns:[/bearing|skf|nsk|timken|6205|6206|6305|6308|pillow\s*block/i],keywords:["bearing","skf","nsk","timken","pillow block","6205","6206","6305","6308"],response:`**Bearing Selection — Roll Forming Machines**
...
- Rolls: Thin oil coat (rust prevention when idle)`}],lt="Phi-3.5-mini-instruct-q4f16_1-MLC",U=90;let I=null,G=0,Q=!1;const ct=[{patterns:[/springback/i,/spring\s*back/i],keywords:["springback","overbend","compensation"],response:`**Springback Compensation — Expert Guide**
...
**Thread Whirling:** 5-10× faster than single-point. Whirl head at 5000-12000 RPM. For bone screws, lead screws.`}],W=[...ct,...ot];function dt(t,s){const i=t.toLowerCase();for(const l of W)for(const p of l.patterns)if(p.test(t))return l.response;let o=null,r=0;for(const l of W){let p=0;for(const h of l.keywords)i.includes(h)&&(p+=h.length);p>r&&(r=p,o=l)}if(o&&r>3)return o.response;const a=[];for(const l of s.slice(-4))if(l.role==="assistant")for(const p of W)for(const h of p.keywords)l.content.toLowerCase().includes(h)&&a.push(h);if(a.length>0){const l=a.join(" ")+" "+i;for(const p of W){let h=0;for(const y of p.keywords)l.includes(y)&&(h+=y.length);h>r&&(r=h,o=p)}if(o&&r>3)return o.response}return`I'm running in CPU mode with a built-in knowledge base covering roll forming, CNC turning, materials, defects, G-code, and safety.
...
Offline AI — 100% Local, Zero Internet Required.`}function mt(){const[t,s]=n.useState({status:"idle",progress:0,progressText:"",error:null,timeoutCountdown:null,vramWarning:null}),i=n.useRef(!1),o=n.useCallback(()=>!(typeof navigator>"u"||!("gpu"in navigator)),[]),r=n.useCallback(async()=>{try{if(!("gpu"in navigator))return{ok:!0,warning:null};const g=await navigator.gpu.requestAdapter();if(!g)return{ok:!0,warning:null};const f=g.limits;if(!f)return{ok:!0,warning:null};const m=f.maxBufferSize;if(typeof m=="number"){const b=m/1073741824;if(b<2)return{ok:!1,warning:`Low GPU memory detected (~${b.toFixed(1)} GB). The AI model requires at least 2 GB of VRAM. Loading may fail or cause browser instability.`}}return{ok:!0,warning:null}}catch{return{ok:!0,warning:null}}},[]),a=n.useCallback(async(y,g)=>{const f=()=>G!==g||i.current;let m=!1,b=null,S=null;const c=()=>{b&&(clearTimeout(b),b=null),S&&(clearInterval(S),S=null)};return new Promise(w=>{let v=!1;const C=d=>{v||(v=!0,c(),w(d))};let x=U;S=setInterval(()=>{x-=1,f()||s(d=>({...d,timeoutCountdown:x}))},1e3),b=setTimeout(()=>{m=!0,C({success:!1,timedOut:!0})},U*1e3),y.CreateMLCEngine(lt,{initProgressCallback:d=>{if(f()||m)return;const k=Math.round((d.progress??0)*100);s(N=>({...N,status:k>=100?"loading":"downloading",progress:k,progressText:d.text??`Loading… ${k}%`,error:null}))}}).then(d=>{f()||m||C({success:!0,engine:d,timedOut:!1})}).catch(()=>{f()||m||C({success:!1,timedOut:!1})})})},[]),l=n.useCallback(async()=>{if(t.status==="ready"||t.status==="ready_cpu"||t.status==="downloading"||t.status==="loading")return;if(!o()){Q=!0,s({status:"ready_cpu",progress:100,progressText:"CPU Mode — Domain Knowledge Engine active",error:null,timeoutCountdown:null,vramWarning:"WebGPU not available. Running in CPU fallback mode with built-in engineering knowledge base (11 expert domains, 33 materials)."});return}i.current=!1,G++,s({status:"checking",progress:0,progressText:"Checking browser capabilities…",error:null,timeoutCountdown:null,vramWarning:null});const y=await r(),g=y.warning;y.ok||s(f=>({...f,vramWarning:g}));try{const f=await qe(()=>import("./vendor-misc-CRnL6q1x.js").then(v=>v.aY),__vite__mapDeps([0,1,2,3,4,5,6]));if(I){s({status:"ready",progress:100,progressText:"AI Model ready",error:null,timeoutCountdown:null,vramWarning:g});return}const m=f,b=++G;s({status:"downloading",progress:0,progressText:"Starting model download…",error:null,timeoutCountdown:U,vramWarning:g});const S=await a(m,b);if(i.current)return;if(S.success&&S.engine){I=S.engine,s({status:"ready",progress:100,progressText:"AI Model ready — Phi-3.5 Mini online",error:null,timeoutCountdown:null,vramWarning:g});return}const c=++G;s(v=>({...v,status:"downloading",progress:0,progressText:"First attempt failed. Retrying…",timeoutCountdown:U,error:null}));const w=await a(m,c);if(i.current)return;if(w.success&&w.engine){I=w.engine,s({status:"ready",progress:100,progressText:"AI Model ready — Phi-3.5 Mini online",error:null,timeoutCountdown:null,vramWarning:g});return}s(v=>({...v,status:"error",progress:0,progressText:"",timeoutCountdown:null,error:"AI model failed to load after two attempts. This may be due to slow network or insufficient GPU memory. Please refresh the page to try again."}))}catch(f){if(G++,i.current)return;const m=f instanceof Error?f.message:String(f);s(b=>({...b,status:"error",progress:0,progressText:"",error:m,timeoutCountdown:null}))}},[t.status,o,r,a]),p=n.useCallback(async(y,g=[])=>{if(Q)return await new Promise(S=>setTimeout(S,150+Math.random()*350)),dt(y,g);if(!I)throw new Error("AI model is not loaded. Please initialize first.");const f=[{role:"system",content:nt},...g.slice(-12),{role:"user",content:y}];return(await I.chat.completions.create({messages:f,temperature:.6,max_tokens:2048,stream:!1,top_p:.92,repetition_penalty:1.05})).choices?.[0]?.message?.content??"No response generated."},[]),h=n.useCallback(()=>{i.current=!0,G++,I=null,Q=!1,s({status:"idle",progress:0,progressText:"",error:null,timeoutCountdown:null,vramWarning:null})},[]);return{state:t,isSupported:o(),initialize:l,chat:p,reset:h}}function ut({onInitialize:t,progress:s,progressText:i,status:o,error:r,timeoutCountdown:a,vramWarning:l}){const p=o==="downloading"||o==="checking"||o==="loading";return e.jsxs("div",{className:"flex flex-col items-center justify-center h-full gap-6 p-6",children:[e.jsx("div",{className:"w-16 h-16 rounded-2xl bg-indigo-500/15 border border-indigo-500/25 flex items-center justify-center",children:e.jsx(q,{className:"w-8 h-8 text-indigo-400"})}),e.jsxs("div",{className:"text-center max-w-sm",children:[e.jsx("h3",{className:"text-base font-semibold text-zinc-100 mb-1",children:"Local AI Model"}),e.jsx("p",{className:"text-xs text-zinc-500 leading-relaxed",children:"Phi-3.5 Mini — a powerful 3.8B parameter language model that runs 100% in your browser. Download once (~2 GB), then use offline forever. No internet required after download."})]}),l&&e.jsxs("div",{className:"w-full max-w-sm bg-amber-500/10 border border-amber-500/25 rounded-xl p-3 flex gap-2.5 items-start",children:[e.jsx(K,{className:"w-4 h-4 text-amber-400 flex-shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-medium text-amber-300 mb-0.5",children:"Low GPU Memory"}),e.jsx("p",{className:"text-[11px] text-amber-400/80 leading-relaxed",children:l})]})]}),r&&e.jsxs("div",{className:"w-full max-w-sm bg-red-500/10 border border-red-500/25 rounded-xl p-3 flex gap-2.5 items-start",children:[e.jsx(K,{className:"w-4 h-4 text-red-400 flex-shrink-0 mt-0.5"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-medium text-red-300 mb-0.5",children:"Error"}),e.jsx("p",{className:"text-[11px] text-red-400/80 leading-relaxed",children:r})]})]}),p&&e.jsxs("div",{className:"w-full max-w-sm",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs text-zinc-400",children:i||"Loading…"}),e.jsxs("div",{className:"flex items-center gap-2",children:[a!==null&&a>0&&e.jsxs("span",{className:"text-[10px] font-mono text-amber-400/70",children:[Math.floor(a/60),":",(a%60).toString().padStart(2,"0")]}),e.jsxs("span",{className:"text-xs font-mono text-zinc-300",children:[s,"%"]})]})]}),e.jsx("div",{className:"h-2 rounded-full bg-white/[0.06] overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full transition-all duration-300",style:{width:`${Math.max(2,s)}%`}})}),e.jsx("p",{className:"text-[10px] text-zinc-600 mt-1.5 text-center",children:o==="downloading"?"Downloading model files — this may take several minutes on first run":o==="loading"?"Loading model into WebGPU memory…":"Checking browser capabilities…"})]}),!p&&e.jsxs("button",{onClick:t,className:`flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600/80 border border-indigo-500/40
                     text-sm font-semibold text-white hover:bg-indigo-600 transition-colors`,children:[e.jsx(Fe,{className:"w-4 h-4"}),r?"Retry Download":"Download AI Model"]}),e.jsxs("div",{className:"flex items-center gap-4 text-[10px] text-zinc-600",children:[e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(H,{className:"w-3 h-3"})," WebGPU Accelerated"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx($,{className:"w-3 h-3"})," 100% Offline"]}),e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(De,{className:"w-3 h-3"})," Cached in Browser"]})]})]})}function pt({msg:t,aiStatus:s}){const i=t.role==="user";return e.jsxs("div",{className:`flex gap-2.5 ${i?"flex-row-reverse":"flex-row"} mb-3`,children:[e.jsx("div",{className:`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center ${i?"bg-blue-500/20 border border-blue-500/30":"bg-indigo-500/20 border border-indigo-500/30"}`,children:i?e.jsx(he,{className:"w-3.5 h-3.5 text-blue-400"}):e.jsx(E,{className:"w-3.5 h-3.5 text-indigo-400"})}),e.jsxs("div",{className:`max-w-[78%] flex flex-col gap-1 ${i?"items-end":"items-start"}`,children:[e.jsx("div",{className:`rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed whitespace-pre-wrap ${i?"bg-blue-600/25 border border-blue-500/20 text-zinc-100":"bg-white/[0.04] border border-white/[0.06] text-zinc-200"}`,children:t.content}),e.jsxs("div",{className:"flex items-center gap-1.5",children:[e.jsx("span",{className:"text-[10px] text-zinc-700",children:new Date(t.timestamp).toLocaleTimeString()}),e.jsx("span",{className:`text-[9px] px-1.5 py-0.5 rounded-full font-medium ${s==="ready_cpu"?"bg-amber-500/10 text-amber-400":"bg-indigo-500/10 text-indigo-400"}`,children:s==="ready_cpu"?"CPU AI":"Local AI"})]})]})]})}function ht(){const{state:t,initialize:s,chat:i,reset:o}=mt(),[r,a]=n.useState([]),[l,p]=n.useState(""),[h,y]=n.useState(!1),g=n.useRef(null),f=n.useRef(null);n.useEffect(()=>{g.current?.scrollIntoView({behavior:"smooth"})},[r,h]);const m=n.useCallback(async()=>{const c=l.trim();if(!c||h||t.status!=="ready"&&t.status!=="ready_cpu")return;const w={id:`${Date.now()}-u`,role:"user",content:c,timestamp:new Date().toISOString()};a(v=>[...v,w]),p(""),y(!0);try{const v=r.slice(-8).map(d=>({role:d.role,content:d.content})),C=await i(c,v),x={id:`${Date.now()}-a`,role:"assistant",content:C,timestamp:new Date().toISOString()};a(d=>[...d,x])}catch(v){const C={id:`${Date.now()}-err`,role:"assistant",content:`Sai Rolotech AI — Response generate nahi ho saka. ${v instanceof Error?v.message:"Please try again."}`,timestamp:new Date().toISOString()};a(x=>[...x,C])}y(!1),f.current?.focus()},[l,h,t.status,i,r]),b=c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),m())},S=()=>{confirm("Clear local AI chat history?")&&a([])};return t.status==="idle"||t.status==="not_downloaded"||t.status==="downloading"||t.status==="checking"||t.status==="loading"||t.status==="error"||t.status==="not_supported"?e.jsx(ut,{onInitialize:s,progress:t.progress,progressText:t.progressText,status:t.status,error:t.error,timeoutCountdown:t.timeoutCountdown,vramWarning:t.vramWarning}):e.jsxs("div",{className:"flex flex-col h-full",children:[e.jsxs("div",{className:"flex items-center justify-between px-4 py-3 border-b border-white/[0.06] flex-shrink-0",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(q,{className:"w-4 h-4 text-indigo-400"}),e.jsx("span",{className:"text-sm font-semibold text-zinc-100",children:"Local AI"}),e.jsx("span",{className:`text-[10px] px-2 py-0.5 rounded-full font-semibold ${t.status==="ready_cpu"?"bg-amber-500/10 border border-amber-500/25 text-amber-400":"bg-indigo-500/10 border border-indigo-500/25 text-indigo-400"}`,children:t.status==="ready_cpu"?"CPU Mode · Knowledge Engine":"Phi-3.5 Mini · 100% Offline"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{onClick:o,title:"Unload model",className:"flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] text-zinc-500 bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.07] transition-colors",children:[e.jsx(D,{className:"w-3 h-3"})," Reset"]}),e.jsxs("button",{onClick:S,title:"Clear chat",className:"flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] text-red-400 bg-red-500/8 border border-red-500/15 hover:bg-red-500/15 transition-colors",children:[e.jsx(ue,{className:"w-3 h-3"})," Clear"]})]})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto p-4 min-h-0",children:[r.length===0&&e.jsxs("div",{className:"flex flex-col items-center justify-center h-32 text-zinc-600 text-sm gap-2",children:[e.jsx(E,{className:"w-8 h-8 text-zinc-700"}),e.jsx("p",{children:"Local AI ready — ask anything"}),e.jsx("p",{className:"text-[11px] text-center leading-relaxed",children:"Roll forming defects · TurnAxis CAM G-code · CNC turning · Materials · Hindi/Urdu/English"})]}),r.map(c=>e.jsx(pt,{msg:c,aiStatus:t.status},c.id)),h&&e.jsxs("div",{className:"flex gap-2.5 mb-3",children:[e.jsx("div",{className:"w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center bg-indigo-500/20 border border-indigo-500/30",children:e.jsx(E,{className:"w-3.5 h-3.5 text-indigo-400"})}),e.jsx("div",{className:"bg-white/[0.04] border border-white/[0.06] rounded-2xl px-4 py-3",children:e.jsxs("div",{className:"flex gap-1 items-center",children:[e.jsx("div",{className:"w-1.5 h-1.5 bg-indigo-400 rounded-full animate-bounce [animation-delay:0ms]"}),e.jsx("div",{className:"w-1.5 h-1.5 bg-indigo-400 rounded-full animate-bounce [animation-delay:150ms]"}),e.jsx("div",{className:"w-1.5 h-1.5 bg-indigo-400 rounded-full animate-bounce [animation-delay:300ms]"})]})})]}),e.jsx("div",{ref:g})]}),e.jsxs("div",{className:"px-4 pb-4 pt-2 flex-shrink-0 border-t border-white/[0.06]",children:[e.jsxs("div",{className:"flex gap-2 items-end",children:[e.jsx("textarea",{ref:f,value:l,onChange:c=>p(c.target.value),onKeyDown:b,placeholder:"Ask anything in Hindi, Urdu, or English… (Enter to send)",rows:2,disabled:h,className:`flex-1 bg-white/[0.04] border border-white/[0.08] rounded-xl px-3.5 py-2.5
                       text-sm text-zinc-200 placeholder-zinc-600 resize-none
                       ...
                       transition-colors flex-shrink-0`,children:h?e.jsx(T,{className:"w-4 h-4 animate-spin"}):e.jsx(pe,{className:"w-4 h-4"})})]}),e.jsx("p",{className:"text-[10px] text-zinc-700 mt-1.5",children:"Running locally on your device · No internet · No data sent anywhere"})]})]})}function gt(){const[t,s]=n.useState({capabilities:null,initialized:!1,workerPoolSize:0,activeWorkers:0,queuedTasks:0,totalProcessed:0,avgComputeMs:0,memoryUsedMB:0,memoryPercent:0}),i=n.useRef(null),o=n.useCallback(()=>{const r=Ze();Xe();const a=te(),l=ae();s({capabilities:r,initialized:!0,workerPoolSize:a.poolSize,activeWorkers:a.active,queuedTasks:a.queued,totalProcessed:a.totalProcessed,avgComputeMs:a.avgComputeMs,memoryUsedMB:l.usedMB,memoryPercent:l.percent})},[]);return n.useEffect(()=>(o(),i.current=setInterval(()=>{const r=te(),a=ae();s(l=>({...l,activeWorkers:r.active,queuedTasks:r.queued,totalProcessed:r.totalProcessed,avgComputeMs:r.avgComputeMs,workerPoolSize:r.poolSize,memoryUsedMB:a.usedMB,memoryPercent:a.percent}))},2e3),()=>{i.current&&clearInterval(i.current)}),[o]),t}function ft({value:t,size:s=48,stroke:i=4,color:o}){const r=(s-i)/2,a=2*Math.PI*r,l=a-Math.min(100,t)/100*a;return e.jsxs("svg",{width:s,height:s,className:"transform -rotate-90",children:[e.jsx("circle",{cx:s/2,cy:s/2,r,fill:"none",stroke:"rgba(255,255,255,0.06)",strokeWidth:i}),e.jsx("circle",{cx:s/2,cy:s/2,r,fill:"none",stroke:o,strokeWidth:i,strokeDasharray:a,strokeDashoffset:l,strokeLinecap:"round",className:"transition-all duration-700"})]})}function F({icon:t,label:s,value:i,sub:o,accent:r,children:a}){return e.jsxs("div",{className:`rounded-xl p-3 border ${r} bg-white/[0.02] flex flex-col gap-2`,children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"w-6 h-6 rounded-lg flex items-center justify-center bg-white/[0.05]",children:t}),e.jsx("span",{className:"text-[10px] text-zinc-500 font-semibold uppercase tracking-wider",children:s})]}),e.jsx("div",{className:"text-sm font-bold text-zinc-100",children:i}),o&&e.jsx("div",{className:"text-[10px] text-zinc-600",children:o}),a]})}function O({value:t,max:s,color:i,label:o}){const r=Math.min(100,t/Math.max(s,1)*100);return e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[9px] text-zinc-600 w-16 truncate",children:o}),e.jsx("div",{className:"flex-1 bg-white/[0.06] rounded-full h-1.5 overflow-hidden",children:e.jsx("div",{className:`h-full rounded-full transition-all duration-500 ${i}`,style:{width:`${r}%`}})}),e.jsxs("span",{className:"text-[9px] text-zinc-500 w-8 text-right",children:[Math.round(r),"%"]})]})}function xt(){const t=gt(),[s,i]=n.useState({active:0,queued:0,processed:0,avgMs:0}),[o,r]=n.useState({usedMB:0,percent:0});n.useEffect(()=>{const f=setInterval(()=>{const m=te(),b=ae();i({active:m.active,queued:m.queued,processed:m.totalProcessed,avgMs:m.avgComputeMs}),r({usedMB:b.usedMB,percent:b.percent})},1500);return()=>clearInterval(f)},[]);const a=t.capabilities;if(!a)return e.jsxs("div",{className:"flex items-center justify-center h-48 text-zinc-600 text-sm",children:[e.jsx(J,{className:"w-4 h-4 animate-spin mr-2"}),"Detecting hardware..."]});const l=Math.min(100,a.cpu.cores*12.5),p=a.gpu.tier==="ultra"?100:a.gpu.tier==="high"?75:a.gpu.tier==="medium"?50:25,h=Math.min(100,a.memory.deviceMemoryGB*12.5),y=Math.round((l+p+h)/3),g={ultra:"text-violet-400",high:"text-emerald-400",medium:"text-amber-400",low:"text-red-400"}[a.recommended.simulationQuality];return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsxs("h3",{className:"text-sm font-bold text-zinc-100 flex items-center gap-2",children:[e.jsx(ge,{className:"w-4 h-4 text-cyan-400"}),"Hardware Acceleration Engine"]}),e.jsx("p",{className:"text-[10px] text-zinc-600 mt-0.5",children:"Maximum power · All processors active · Real-time monitoring"})]}),e.jsx("div",{className:"flex items-center gap-2",children:e.jsxs("span",{className:`text-[10px] px-2 py-0.5 rounded-full font-bold border ${g} ${a.recommended.simulationQuality==="ultra"?"bg-violet-500/10 border-violet-500/25":a.recommended.simulationQuality==="high"?"bg-emerald-500/10 border-emerald-500/25":a.recommended.simulationQuality==="medium"?"bg-amber-500/10 border-amber-500/25":"bg-red-500/10 border-red-500/25"}`,children:[a.recommended.simulationQuality.toUpperCase()," Quality"]})})]}),e.jsxs("div",{className:"flex items-center gap-4 p-3 rounded-xl bg-white/[0.02] border border-white/[0.06]",children:[e.jsxs("div",{className:"relative",children:[e.jsx(ft,{value:y,size:56,stroke:5,color:y>=75?"#22c55e":y>=50?"#eab308":"#ef4444"}),e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:e.jsx("span",{className:"text-xs font-bold text-zinc-100",children:y})})]}),e.jsxs("div",{className:"flex-1",children:[e.jsx("div",{className:"text-xs font-semibold text-zinc-200",children:"Hardware Power Score"}),e.jsxs("div",{className:"text-[10px] text-zinc-500 mt-0.5",children:[a.cpu.cores," CPU cores · ",a.gpu.tier.toUpperCase()," GPU · ",a.memory.deviceMemoryGB,"GB RAM"]}),e.jsxs("div",{className:"flex gap-3 mt-1.5",children:[e.jsx(O,{value:l,max:100,color:"bg-blue-500",label:"CPU"}),e.jsx(O,{value:p,max:100,color:"bg-green-500",label:"GPU"}),e.jsx(O,{value:h,max:100,color:"bg-purple-500",label:"RAM"})]})]})]}),e.jsxs("div",{className:"grid grid-cols-2 lg:grid-cols-3 gap-3",children:[e.jsx(F,{icon:e.jsx(H,{className:"w-3.5 h-3.5 text-blue-400"}),label:"CPU Cores",value:`${a.cpu.cores} Threads`,sub:`Speed: ${a.cpu.estimatedSpeed} · ${a.cpu.logicalProcessors} logical`,accent:"border-blue-500/15",children:e.jsx(O,{value:s.active,max:a.workers.maxWorkers,color:"bg-blue-500",label:"Active"})}),e.jsx(F,{icon:e.jsx(Ee,{className:"w-3.5 h-3.5 text-green-400"}),label:"GPU",value:a.gpu.tier.toUpperCase(),sub:a.gpu.renderer.length>30?a.gpu.renderer.substring(0,30)+"…":a.gpu.renderer,accent:"border-green-500/15",children:e.jsxs("div",{className:"flex flex-wrap gap-1 mt-1",children:[a.gpu.webgl2&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-green-500/10 text-green-400",children:"WebGL2"}),a.gpu.webgpu&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-violet-500/10 text-violet-400",children:"WebGPU"}),a.gpu.floatTextures&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-cyan-500/10 text-cyan-400",children:"Float32"}),a.gpu.instancing&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-amber-500/10 text-amber-400",children:"Instancing"})]})}),e.jsx(F,{icon:e.jsx(de,{className:"w-3.5 h-3.5 text-purple-400"}),label:"Memory",value:`${a.memory.deviceMemoryGB} GB`,sub:`JS Heap: ${o.usedMB}MB / ${a.memory.jsHeapLimitMB}MB`,accent:"border-purple-500/15",children:e.jsx(O,{value:o.percent,max:100,color:o.percent>80?"bg-red-500":"bg-purple-500",label:"Used"})}),e.jsx(F,{icon:e.jsx(ze,{className:"w-3.5 h-3.5 text-cyan-400"}),label:"Worker Pool",value:`${a.workers.maxWorkers} Workers`,sub:`Active: ${s.active} · Queue: ${s.queued}`,accent:"border-cyan-500/15",children:e.jsx("div",{className:"flex gap-1 mt-1",children:Array.from({length:a.workers.maxWorkers}).map((f,m)=>e.jsx("div",{className:`w-2.5 h-2.5 rounded-full transition-colors ${m<s.active?"bg-cyan-400 animate-pulse":"bg-white/[0.08]"}`},m))})}),e.jsx(F,{icon:e.jsx(Le,{className:"w-3.5 h-3.5 text-amber-400"}),label:"Compute Stats",value:`${s.processed} Tasks`,sub:`Avg: ${s.avgMs}ms per task`,accent:"border-amber-500/15"}),e.jsx(F,{icon:e.jsx(Oe,{className:"w-3.5 h-3.5 text-rose-400"}),label:"Optimization",value:`Mesh: ${a.recommended.meshDensity}x`,sub:`Max triangles: ${(a.recommended.maxTriangles/1e3).toFixed(0)}K · Batch: ${a.recommended.batchSize}`,accent:"border-rose-500/15",children:e.jsxs("div",{className:"flex flex-wrap gap-1 mt-1",children:[a.workers.supportsSharedArrayBuffer&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-emerald-500/10 text-emerald-400",children:"SharedMem"}),a.workers.supportsOffscreenCanvas&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-blue-500/10 text-blue-400",children:"OffscreenCanvas"}),a.workers.supportsTransferable&&e.jsx("span",{className:"text-[8px] px-1 py-0.5 rounded bg-amber-500/10 text-amber-400",children:"Transferable"})]})})]}),e.jsxs("div",{className:"rounded-xl p-3 bg-white/[0.02] border border-white/[0.06]",children:[e.jsx("div",{className:"text-[10px] font-semibold text-zinc-400 uppercase tracking-wider mb-2",children:"GPU Capabilities"}),e.jsxs("div",{className:"grid grid-cols-2 gap-x-6 gap-y-1",children:[e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Max Texture"}),e.jsxs("span",{className:"text-zinc-300",children:[a.gpu.maxTextureSize,"px"]})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Draw Buffers"}),e.jsx("span",{className:"text-zinc-300",children:a.gpu.maxDrawBuffers})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Vertex Attribs"}),e.jsx("span",{className:"text-zinc-300",children:a.gpu.maxVertexAttribs})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Pixel Ratio"}),e.jsxs("span",{className:"text-zinc-300",children:[a.performance.pixelRatio.toFixed(1),"x"]})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Vendor"}),e.jsx("span",{className:"text-zinc-300 truncate max-w-[120px]",children:a.gpu.vendor})]}),e.jsxs("div",{className:"flex justify-between text-[10px]",children:[e.jsx("span",{className:"text-zinc-500",children:"Connection"}),e.jsx("span",{className:"text-zinc-300",children:a.performance.connectionType})]})]})]}),e.jsxs("p",{className:"text-[9px] text-zinc-700 text-right",children:["All ",a.cpu.cores," CPU cores + ",a.gpu.tier.toUpperCase()," GPU active · Worker pool auto-sized · Real-time refresh"]})]})}const bt={info:"text-zinc-400",success:"text-emerald-400",warn:"text-amber-400",error:"text-red-400"};function ce({ok:t,label:s}){return e.jsxs("span",{className:`inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full font-medium ${t?"bg-emerald-500/15 text-emerald-300 border border-emerald-500/30":"bg-red-500/15 text-red-300 border border-red-500/30"}`,children:[t?e.jsx(Z,{className:"w-3 h-3"}):e.jsx(ee,{className:"w-3 h-3"}),s]})}function V({icon:t,label:s,value:i,sub:o,color:r="zinc"}){const a={zinc:"border-zinc-700/60 bg-zinc-800/50",emerald:"border-emerald-700/40 bg-emerald-900/20",red:"border-red-700/40 bg-red-900/20",amber:"border-amber-700/40 bg-amber-900/20",blue:"border-blue-700/40 bg-blue-900/20"},l={zinc:"text-zinc-200",emerald:"text-emerald-300",red:"text-red-300",amber:"text-amber-300",blue:"text-blue-300"};return e.jsxs("div",{className:`rounded-lg border p-3 ${a[r]}`,children:[e.jsxs("div",{className:"flex items-center gap-2 text-zinc-400 text-xs mb-1",children:[t," ",s]}),e.jsx("div",{className:`text-lg font-bold tabular-nums ${l[r]}`,children:i}),o&&e.jsx("div",{className:"text-zinc-500 text-xs mt-0.5 truncate",children:o})]})}function yt(){const[t,s]=n.useState(null),[i,o]=n.useState(!0),[r,a]=n.useState(!1),[l,p]=n.useState(null),[h,y]=n.useState(null),g=n.useCallback(async()=>{try{const c=await fetch("/api/system/watchdog-status");if(!c.ok)throw new Error(`HTTP ${c.status}`);const w=await c.json();s(w),y(null)}catch(c){y(c instanceof Error?c.message:String(c))}finally{o(!1)}},[]);n.useEffect(()=>{g();const c=setInterval(()=>{g()},3e4);return()=>clearInterval(c)},[g]);const f=async()=>{a(!0),p(null);try{const w=await(await fetch("/api/system/auto-push",{method:"POST"})).json();p({ok:w.ok,msg:w.message}),await g()}catch(c){p({ok:!1,msg:c instanceof Error?c.message:"Error"})}finally{a(!1)}};function m(c){if(!c)return"—";try{return new Date(c).toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}catch{return c}}if(i)return e.jsxs("div",{className:"flex items-center justify-center h-48 text-zinc-500 gap-2",children:[e.jsx(D,{className:"w-4 h-4 animate-spin"})," Loading watchdog status..."]});if(h)return e.jsxs("div",{className:"flex flex-col items-center justify-center h-48 text-red-400 gap-2",children:[e.jsx(K,{className:"w-6 h-6"}),e.jsxs("span",{className:"text-sm",children:["API se data nahi aa raha: ",h]}),e.jsx("button",{onClick:()=>{g()},className:"mt-2 text-xs px-3 py-1 rounded bg-zinc-800 border border-zinc-700 hover:bg-zinc-700 text-zinc-300",children:"Retry karo"})]});if(!t)return null;const b=t.consecutiveFailures===0&&t.healthChecksPassed>0,S=t.lastGitPushResult?.includes("pushed")||t.lastGitPushResult?.includes("up-to-date");return e.jsxs("div",{className:"flex flex-col gap-4 p-4 overflow-y-auto h-full text-sm",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(fe,{className:"w-5 h-5 text-blue-400"}),e.jsx("h2",{className:"font-semibold text-zinc-100 text-base",children:"System Watchdog"}),e.jsx(ce,{ok:b,label:b?"API Healthy":"API Issue"}),!t.isElectron&&e.jsx(ce,{ok:!!S,label:S?"GitHub Synced":"Sync Check"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>{g()},className:"p-1.5 rounded hover:bg-zinc-800 text-zinc-400 hover:text-zinc-200 transition-colors",title:"Refresh",children:e.jsx(D,{className:"w-3.5 h-3.5"})}),!t.isElectron&&e.jsx("button",{onClick:()=>{f()},disabled:r,className:"flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-white transition-colors",children:r?e.jsxs(e.Fragment,{children:[e.jsx(D,{className:"w-3 h-3 animate-spin"})," Pushing..."]}):e.jsxs(e.Fragment,{children:[e.jsx(Y,{className:"w-3 h-3"})," GitHub Push"]})})]})]}),l&&e.jsxs("div",{className:`rounded-lg border px-3 py-2 text-xs flex items-center gap-2 ${l.ok?"bg-emerald-900/20 border-emerald-700/40 text-emerald-300":"bg-red-900/20 border-red-700/40 text-red-300"}`,children:[l.ok?e.jsx(Z,{className:"w-3.5 h-3.5"}):e.jsx(ee,{className:"w-3.5 h-3.5"}),l.msg,e.jsx("button",{onClick:()=>p(null),className:"ml-auto opacity-60 hover:opacity-100",children:"✕"})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 md:grid-cols-4",children:[e.jsx(V,{icon:e.jsx(J,{className:"w-3.5 h-3.5"}),label:"Health Checks OK",value:t.healthChecksPassed,sub:`Last: ${m(t.lastHealthCheck)}`,color:"emerald"}),e.jsx(V,{icon:e.jsx(K,{className:"w-3.5 h-3.5"}),label:"Health Failures",value:t.healthChecksFailed,sub:`Consecutive: ${t.consecutiveFailures}/5`,color:t.consecutiveFailures>0?"red":"zinc"}),!t.isElectron&&e.jsxs(e.Fragment,{children:[e.jsx(V,{icon:e.jsx(oe,{className:"w-3.5 h-3.5"}),label:"GitHub Pushes",value:t.gitPushCount,sub:`Last: ${m(t.lastGitPush)}`,color:"blue"}),e.jsx(V,{icon:e.jsx(ee,{className:"w-3.5 h-3.5"}),label:"Push Errors",value:t.gitPushErrors,sub:t.lastGitPushResult?.slice(0,40)??"—",color:t.gitPushErrors>0?"amber":"zinc"})]})]}),!t.isElectron&&e.jsxs("div",{className:"rounded-lg border border-zinc-700/60 bg-zinc-800/40 p-3",children:[e.jsxs("div",{className:"flex items-center gap-2 text-zinc-400 text-xs mb-2",children:[e.jsx(oe,{className:"w-3.5 h-3.5"})," GitHub Auto-Sync Status"]}),e.jsxs("div",{className:"grid grid-cols-2 gap-x-4 gap-y-1 text-xs",children:[e.jsx("span",{className:"text-zinc-500",children:"Last Push:"}),e.jsx("span",{className:"text-zinc-300 font-mono",children:m(t.lastGitPush)}),e.jsx("span",{className:"text-zinc-500",children:"Result:"}),e.jsx("span",{className:`font-mono ${t.lastGitPushResult?.includes("pushed")?"text-emerald-400":t.lastGitPushResult?.includes("up-to-date")?"text-blue-400":t.lastGitPushResult?.includes("failed")?"text-red-400":"text-zinc-400"}`,children:t.lastGitPushResult??"—"}),e.jsx("span",{className:"text-zinc-500",children:"Mode:"}),e.jsx("span",{className:"text-zinc-300",children:"Auto-push every 10 min"})]})]}),e.jsxs("div",{className:"rounded-lg border border-zinc-700/60 bg-zinc-800/40 p-3",children:[e.jsxs("div",{className:"flex items-center gap-2 text-zinc-400 text-xs mb-2",children:[e.jsx(J,{className:"w-3.5 h-3.5"})," Server Info"]}),e.jsxs("div",{className:"grid grid-cols-2 gap-x-4 gap-y-1 text-xs",children:[e.jsx("span",{className:"text-zinc-500",children:"API Port:"}),e.jsx("span",{className:"text-zinc-300 font-mono",children:t.apiPort}),e.jsx("span",{className:"text-zinc-500",children:"Mode:"}),e.jsx("span",{className:"text-zinc-300",children:t.isElectron?"Desktop (Electron)":"Cloud (Replit)"}),e.jsx("span",{className:"text-zinc-500",children:"Started At:"}),e.jsx("span",{className:"text-zinc-300 font-mono",children:m(t.startedAt)})]})]}),e.jsxs("div",{className:"rounded-lg border border-zinc-700/60 bg-zinc-900/60 flex flex-col min-h-0",children:[e.jsxs("div",{className:"flex items-center gap-2 px-3 py-2 border-b border-zinc-700/40 text-zinc-400 text-xs",children:[e.jsx(me,{className:"w-3.5 h-3.5"})," Recent Activity (last 20)"]}),e.jsxs("div",{className:"overflow-y-auto max-h-48 font-mono text-xs p-2 space-y-0.5",children:[t.logs.length===0&&e.jsx("div",{className:"text-zinc-600 py-2 text-center",children:"Koi activity nahi abhi tak..."}),[...t.logs].reverse().slice(0,20).map((c,w)=>e.jsxs("div",{className:"flex gap-2",children:[e.jsx("span",{className:"text-zinc-600 flex-shrink-0",children:c.time}),e.jsx("span",{className:bt[c.type],children:c.message})]},w))]})]})]})}const St=[{id:"system",label:"System Info",icon:e.jsx(Be,{className:"w-4 h-4"})},{id:"hardware",label:"Hardware",icon:e.jsx(ge,{className:"w-4 h-4"})},{id:"chat",label:"AI Chat",icon:e.jsx(q,{className:"w-4 h-4"})},{id:"localai",label:"Local AI",icon:e.jsx(H,{className:"w-4 h-4"})},{id:"files",label:"File Manager",icon:e.jsx(Ue,{className:"w-4 h-4"})},{id:"settings",label:"Settings",icon:e.jsx(We,{className:"w-4 h-4"})},{id:"watchdog",label:"Auto Sync",icon:e.jsx(fe,{className:"w-4 h-4"})}];function wt({isOnline:t}){const[s,i]=n.useState(!1),o=n.useRef(t),[r,a]=n.useState("");return n.useEffect(()=>{if(o.current!==t){a(t?"Connection restored — switching to Online AI mode":"Internet lost — AI automatically switched to Offline mode. No data lost."),i(!0);const l=setTimeout(()=>i(!1),5e3);return o.current=t,()=>clearTimeout(l)}},[t]),s?e.jsxs("div",{className:`flex items-center gap-2 px-4 py-2 text-sm font-medium transition-all ${t?"bg-emerald-500/15 border-b border-emerald-500/25 text-emerald-300":"bg-amber-500/15 border-b border-amber-500/25 text-amber-300"}`,children:[e.jsx(He,{className:"w-3.5 h-3.5 flex-shrink-0"}),r,e.jsx("button",{onClick:()=>i(!1),className:"ml-auto text-current opacity-60 hover:opacity-100",children:"✕"})]}):null}function Dt(){const[t,s]=n.useState("system"),i=xe();return e.jsxs("div",{className:"flex flex-col h-full bg-[#07070F] text-zinc-100",children:[e.jsx(wt,{isOnline:i.isOnline}),e.jsxs("div",{className:"flex items-center justify-between px-5 py-3 border-b border-white/[0.06] flex-shrink-0",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-bold text-zinc-100 tracking-tight",children:"Ultra AI Dashboard"}),e.jsx("p",{className:"text-[11px] text-zinc-600 mt-0.5",children:"All-in-one AI control center · hardware · system · chat · files"})]}),e.jsx("div",{className:"flex items-center gap-2",children:e.jsx("span",{className:`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-semibold ${i.isOnline?"bg-emerald-500/10 border border-emerald-500/25 text-emerald-400":"bg-amber-500/12 border border-amber-500/30 text-amber-400 animate-pulse"}`,children:i.isOnline?e.jsxs(e.Fragment,{children:[e.jsx(se,{className:"w-2.5 h-2.5"})," Online AI Active"]}):e.jsxs(e.Fragment,{children:[e.jsx($,{className:"w-2.5 h-2.5"})," Offline AI Active"]})})})]}),e.jsx("div",{className:"flex gap-0.5 px-4 pt-3 border-b border-white/[0.06] flex-shrink-0 overflow-x-auto",children:St.map(o=>{const r=t===o.id;return e.jsxs("button",{onClick:()=>s(o.id),className:`flex items-center gap-1.5 px-3.5 py-2 text-[12px] font-medium rounded-t-lg relative transition-colors whitespace-nowrap ${r?"text-blue-300 bg-white/[0.05]":"text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.03]"}`,children:[e.jsx("span",{className:r?"text-blue-400":"text-zinc-600",children:o.icon}),o.label,r&&e.jsx("span",{className:"absolute bottom-0 left-0 right-0 h-[2px] bg-blue-500 rounded-full opacity-70"})]},o.id)})}),e.jsxs("div",{className:"flex-1 overflow-hidden",children:[t==="system"&&e.jsx("div",{className:"h-full overflow-y-auto p-5",children:e.jsx(Ye,{})}),t==="hardware"&&e.jsx("div",{className:"h-full overflow-y-auto p-5",children:e.jsx(xt,{})}),t==="chat"&&e.jsx("div",{className:"h-full flex flex-col",children:e.jsx(et,{})}),t==="localai"&&e.jsx("div",{className:"h-full flex flex-col",children:e.jsx(ht,{})}),t==="files"&&e.jsx("div",{className:"h-full flex flex-col",children:e.jsx(st,{})}),t==="settings"&&e.jsx("div",{className:"h-full overflow-y-auto",children:e.jsx(rt,{})}),t==="watchdog"&&e.jsx("div",{className:"h-full overflow-hidden",children:e.jsx(yt,{})})]})]})}export{Dt as UltraDashboard};
