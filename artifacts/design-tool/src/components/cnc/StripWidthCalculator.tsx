...
const MATERIAL_FULL_PROPS: Record<MaterialType, {
  ...
  GI:   { name: "Galvanized Iron", tensile: "350 MPa", yield: "250 MPa", kFactor: 0.44, springback: "5%", minRadius: "1.0×t", density: "7.85 g/cm³", notes: "Zinc coating may flake at r/t < 1.0" },
  CR:   { name: "Cold Rolled Steel", tensile: "400 MPa", yield: "280 MPa", kFactor: 0.42, springback: "8%", minRadius: "0.5×t", density: "7.85 g/cm³", notes: "Excellent formability; low springback" },
  HR:   { name: "Hot Rolled Steel", tensile: "420 MPa", yield: "250 MPa", kFactor: 0.38, springback: "12%", minRadius: "1.5×t", density: "7.85 g/cm³", notes: "Descale before forming; higher springback" },
  SS:   { name: "Stainless Steel", tensile: "620 MPa", yield: "310 MPa", kFactor: 0.40, springback: "20%", minRadius: "2.0×t", density: "7.93 g/cm³", notes: "CRITICAL: work hardening risk; flood coolant mandatory" },
  AL:   { name: "Aluminium", tensile: "220 MPa", yield: "130 MPa", kFactor: 0.43, springback: "15%", minRadius: "1.0×t", density: "2.70 g/cm³", notes: "Low force but high springback; scratch risk. Typical grades: 3003, 5052" },
  MS:   { name: "Mild Steel", tensile: "410 MPa", yield: "250 MPa", kFactor: 0.45, springback: "6%", minRadius: "0.8×t", density: "7.85 g/cm³", notes: "Most predictable material for roll forming" },
  CU:   { name: "Copper", tensile: "220 MPa", yield: "70 MPa", kFactor: 0.42, springback: "8%", minRadius: "0.5×t", density: "8.96 g/cm³", notes: "Very soft, excellent formability. Surface scratch risk — polished rolls required" },
  TI:   { name: "Titanium", tensile: "950 MPa", yield: "880 MPa", kFactor: 0.38, springback: "25%", minRadius: "3.0×t", density: "4.51 g/cm³", notes: "CRITICAL: very high springback, reactive. Slow speed, flood coolant, large radii" },
  PP:   { name: "Pre-Painted Steel", tensile: "370 MPa", yield: "250 MPa", kFactor: 0.44, springback: "6%", minRadius: "1.5×t", density: "7.85 g/cm³", notes: "Coating protection critical — no sharp edges, protective film during forming" },
  HSLA: { name: "High-Strength Low-Alloy", tensile: "550 MPa", yield: "450 MPa", kFactor: 0.40, springback: "14%", minRadius: "2.0×t", density: "7.85 g/cm³", notes: "High strength, significant springback. Calibration stands essential" },
};
