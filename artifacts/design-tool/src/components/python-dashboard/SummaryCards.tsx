...
const FIELDS: Array<[string, string, string?, string?]> = [
  ...
  ["Stations (min)", "min_station_count", "", "text-blue-400"],
  ["Stations (rec)", "recommended_station_count", "", "text-green-400"],
  ["Stations (premium)", "premium_station_count", "", "text-violet-400"],
  ...
  ["Line Length", "total_line_length_m", " m"],
        ...
        {FIELDS.map(([label, key, unit, colorClass]) => {
          ...
          return (
            <div key={key} className="rounded-lg border border-gray-700/40 bg-gray-800/50 px-3 py-2">
              ...
              <div className={`text-sm font-semibold truncate ${colorClass ?? "text-gray-200"}`}>
