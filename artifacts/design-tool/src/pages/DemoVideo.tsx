...
function Scene0() {
  return (
    ...
    >
      ...
      >
        v2.2.11 — Precision Roll Forming Suite
      </motion.div>
    </motion.div>
  );
}
...
// ─── Machine spec data ──────────────────────────────────────────────────────
// U-Channel 40×25×1.2mm GP — Auto calculated by SAI Rolotech Smart Engines v2.2.11
        ...
        <div className="flex gap-0 overflow-hidden" style={{ height: "calc(88vh - 80px)" }}>
          ...
          <div className="flex-1 overflow-auto p-5">
            ...
            <motion.div className="mt-4 flex items-center justify-between text-[9px] font-mono text-zinc-600"
              ...
              <span>Generated by SAI Rolotech Smart Engines v2.2.11 — All calculations verified</span>
          ...
          <motion.div key="winner"
            ...
            <div className="relative z-10 text-center px-8">
              ...
              <motion.p className="text-zinc-400 text-lg mb-8 font-mono"
                ...
                vs Manual Calculation — SAI Rolotech Smart Engines v2.2.11
              </motion.p>
