...
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
  ...
  <!-- UP Roll profile -->
  ${_?`<path d="${_}" class="up-roll"/>`:`<text x="${800/2}" y="${v+5}" text-anchor="middle" class="label" fill="#94a3b8">Upper Roll Profile (generate roll tooling first)</text>`}
