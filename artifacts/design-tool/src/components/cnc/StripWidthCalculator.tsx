...
const MATERIAL_FULL_PROPS: Record<MaterialType, {
  ...
  MS:   { name: "Mild Steel", tensile: "410 MPa", yield: "250 MPa", kFactor: 0.42, springback: "6%", minRadius: "0.8×t", density: "7.85 g/cm³", notes: "Most predictable material for roll forming" },
  CU:   { name: "Copper", tensile: "280 MPa", yield: "200 MPa", kFactor: 0.44, springback: "8%", minRadius: "0.5×t", density: "8.96 g/cm³", notes: "Very soft, excellent formability. Surface scratch risk — polished rolls required" },  // FIX: kf 0.42→0.44
