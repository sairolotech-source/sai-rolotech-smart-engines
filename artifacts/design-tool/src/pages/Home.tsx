...
const LaptopHardwareView = lazy(() => import("../components/cnc/LaptopHardwareView"));
...
const TAB_TO_CAT: Record<string, string> = {
  ...
  "flower-3d": "simulation", "flower-combined": "simulation", "autocad-engineering-drawing": "design", "machine-load-calc": "manufacturing", "roll-data-files": "manufacturing", "roll-export": "manufacturing", "buddy-crm": "ai", "demo-videos": "ai", "roll-tooling-drawing": "design",
  report: "project",
};
...
export default function Home({ onBackToDashboard }: HomeProps) {
  ...
  const navCategories: NavCategory[] = [
    ...
    },
    {
      ...
      tools: [
        ...
        { id: "auto-cnc-planner", label: "Auto CNC AI System (AI + SolidCAM + Safety)", icon: <Cpu className="w-4 h-4" />, desc: "AI se machining plan generate karo → SolidCAM templates → 5 safety locks → AI prompt pack — full automation" },
      ],
    },
    {
      id: "project",
      ...
      tools: [
        ...
        { id: "laptop-hardware", label: "Laptop Hardware + CNC", icon: <Cpu className="w-4 h-4" />, desc: "Laptop detect karo — GPU, RAM, Battery + USB/Serial se CNC machine connect karo" },
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case "laptop-hardware": return <Suspense fallback={<LazyFallback />}><div className="flex-1 overflow-auto animate-fade-slide-in"><LaptopHardwareView /></div></Suspense>;
